...
public abstract class OscPatcher {
  ...
  protected Object[] parseArguments(final byte[] theBytes) {
    ...
    while (myTagIndex < _myTypetag.length) {
      ...
      switch (_myTypetag[myTagIndex]) {
        case (0x63): // char c
          myArguments[myTagIndex] =
              (new Character((char) (Bytes.toInt(Bytes.copy(theBytes, myIndex, 4)))));
          myIndex += 4;
          break;
        case (0x69): // int i
  ...
  public static int i(Object o, int theDefault) {
    return (o instanceof Number) ? ((Number) o).intValue() : theDefault;
  }

  public static char c(Object o) {
  ...
  public static String s(Object o, String theDefault) {
    if (o != null) {
      return o.toString();
    }
    return theDefault;
